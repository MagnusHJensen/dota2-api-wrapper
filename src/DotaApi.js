...
class DotaApi {
  ...
  getMatchDetails(matchId) {
    return fetch(this.API_URL + `matches/${matchId}`)
  ...
  getPlayerData(account_id) {
    return fetch(this.API_URL + `players/${account_id}`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getRecentMatches(account_id) {
    return fetch(this.API_URL + `players/${account_id}/recentMatches`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getRatingHistory(account_id) {
    return fetch(this.API_URL + `players/${account_id}/ratings`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getHeroRankings(account_id) {
    return fetch(this.API_URL + `players/${account_id}/rankings`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getProPlayers() {
    return fetch(this.API_URL + `proPlayers`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getParsedMatches() {
    return fetch(this.API_URL + `parsedMatches`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getMetadata() {
    return fetch(this.API_URL + `metadata`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getDistributions() {
    return fetch(this.API_URL + `distributions`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getServiceStatus() {
    return fetch(this.API_URL + `status`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getServiceHealth() {
    return fetch(this.API_URL + `health`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getAllHeroes() {
    return fetch(this.API_URL + `heroes`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getRecentMatchesWithHero(hero_id) {
    return fetch(this.API_URL + `heroes/${hero_id}/matches`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getMatchupsWithHero(hero_id) {
    return fetch(this.API_URL + `heroes/${hero_id}/matchups`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getDurationsWithHero(hero_id) {
    return fetch(this.API_URL + `heroes/${hero_id}/duration`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getItemPopularityForHero(hero_id) {
    return fetch(this.API_URL + `heroes/${hero_id}/itemPopularity`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getAllHeroesStats() {
    return fetch(this.API_URL + `heroStats`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getLeagueData() {
    return fetch(this.API_URL + `leagues`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getAllTeams() {
    return fetch(this.API_URL + `teams`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getTeam(team_id) {
    return fetch(this.API_URL + `teams/${team_id}`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getTeamMatches(team_id) {
    return fetch(this.API_URL + `teams/${team_id}/matches`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getTeamMatches(team_id) {
    return fetch(this.API_URL + `teams/${team_id}/players`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getTeamMatches(team_id) {
    return fetch(this.API_URL + `teams/${team_id}/heroes`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getReplays(match_id) {
    ...
    return fetch(this.API_URL + `replays${util.query(params)}`)
      .then((res) => util.handleResponse(res))
      .then((json) => {
        json.forEach((val) => {
  ...
  getRecordsOfStat(stat) {
    return fetch(this.API_URL + `records/${stat}`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getItemScenarios(item_name, hero_id) {
    ...
    return fetch(this.API_URL + `scenarios/itemTimings${util.query(params)}`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getLaneRoleScenarios(lane_role, hero_id) {
    ...
    return fetch(this.API_URL + `scenarios/laneRoles${util.query(params)}`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getMiscScenarios(scenario) {
    ...
    return fetch(this.API_URL + `scenarios/misc${util.query(params)}`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
   ...
   */
  getDBSchema() {
    return fetch(this.API_URL + `schema`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
  ...
  getConstants(resource) {
    return fetch(this.API_URL + `constants/${resource}`)
      .then((res) => util.handleResponse(res))
      .catch((error) => error);
  }
}
